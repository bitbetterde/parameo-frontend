...
const body = (
  <>
    ...
    <p>
      Material dimensions may differ by availability and location-dependent merchants. <b>Please adapt sheet size for minimal offcuts.</b> Also the pricing may differ by market development and location-dependend sources. <br/>
To integrate additional materials, both the maximum working area and the power of the cnc machine are significant and should be adjusted via the admin panel to ensure correct calculations of product parts and machine paths. <br/>
